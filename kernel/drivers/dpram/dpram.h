...
//jinglbel_start
#define CONFIG_USE_32KB
//#define CONFIG_USE_16KB

//jinglbel_start
#if defined (CONFIG_USE_16KB)
/* 16KB Size */
...
#define DPRAM_PDA2PHONE_FORMATTED_BUFFER_SIZE		(4096-4) /*1020*/    											// 0x 0000 03FC
...
#define DPRAM_PDA2PHONE_RAW_BUFFER_SIZE				(12276-4) /*15344*/    											// 0x 0000 3BF0
...
#define DPRAM_PHONE2PDA_FORMATTED_BUFFER_SIZE		       (4096-4) /*1020*/    											// 0x 0000 03FC
...
#define DPRAM_PHONE2PDA_RAW_BUFFER_SIZE				(12276-4) /*15344*/												// 0x 0000 3BF0
...
#define DPRAM_START_ADDRESS_PHYS 	 		S5PV310_PA_SROM0
#define DPRAM_SHARED_BANK				0x00000000

#define DPRAM_SHARED_BANK_SIZE				0x8000	/* 32*1024 bytes */
#endif
//jinglbel_end
...
#define INT_MASK_CMD_PIF_COPY_DONE     	0xDBAB
//jinglbel_end
